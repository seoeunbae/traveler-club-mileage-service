...
//
//        Mockito.doReturn(Optional.ofNullable(createPlace()))
//                .when(placeRepository)
//                .findById(Mockito.any(UUID.class));
//
//        Mockito.doReturn(createFirstReview())
//                .when(reviewRepository)
//                .save(Mockito.any(Review.class));
//        Mockito.doReturn(Boolean.FALSE)
//                .when(reviewRepository)
//                .existsByPlaceId(Mockito.any(UUID.class));
//        Mockito.doReturn(Optional.ofNullable(createPhoto1()))
//                .when(photoRepository)
//                .findById(photoId1);
//
//        Mockito.doReturn(Optional.ofNullable(createPhoto2()))
//                .when(photoRepository)
//                .findById(photoId2);
//
